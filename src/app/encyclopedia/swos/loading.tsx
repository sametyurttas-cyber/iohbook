...
export default function SwosLoading() {
  return (
    <div className="min-h-screen bg-[#05060a] text-[#F6F0DF] p-6 md:p-12 flex flex-col justify-between select-none">
      ...
      <div className="max-w-4xl mx-auto w-full flex-1 flex flex-col my-6">
        ...
        {/* Stacked list of SWOS card skeletons */}
        <div className="flex flex-col gap-6">
          <SkeletonTelemetry variant="blue" className="h-[180px]" label="ESTABLISHING CONNECTION WITH SWOS CENTRAL..." />
          <SkeletonTelemetry variant="blue" className="h-[180px]" label="READING SECURE PROTOCOLS..." />
        </div>
      </div>
